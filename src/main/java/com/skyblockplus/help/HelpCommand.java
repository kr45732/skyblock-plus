...
public class HelpCommand extends Command {
	...
	private static final String[] nonAdmin = { "General", "Slayer", "Skills", "Dungeons", "Guild", "Price Commands",
			"Inventory", "Miscellaneous Commands", "Party", "Skyblock Event", };
	private static final String[] admin = ArrayUtils.addAll(nonAdmin, "Settings", "Verify Settings",
			"Guild | Roles & Ranks Settings", "Guild | Apply Settings", "Roles Settings");
	...
	public static void setHelpList() {
		helpDataList.clear();
		helpDataList.addAll(Arrays.asList(
				// General
				new HelpData("help", "Show the help menu with all the commands.", "help")
						...
						.addExamples("help", "help Guild Experience").addAliases("commands"),
				...
				new HelpData("slayer", "Get the slayer data of a player.", "slayer [player] [profile]")
						.addAliases("slayers").addExamples("slayer CrypticPlasma", "slayer CrypticPlasma Zucchini"),
				// Skills
				new HelpData("skills", "Get the skills data of a player.", "skills [player] [profile]")
						.addAliases("skill").addExamples("skills CrypticPlasma", "skills CrypticPlasma Zucchini"),
				...
				new HelpData("essence", "Main essence command.").addSubcommands(
						new HelpData("upgrade", "Interactive message to find the essence amount to upgrade an item.",
								"upgrade <item>").addExamples("upgrade Hyperion"),
						new HelpData("information", "Get the amount of essence to upgrade an item for each level.",
								"information <item>").addExamples("information Hyperion").addAliases("info"),
						new HelpData("player", "Get a player's essence amounts and their essence shop upgrades.",
								"[player] [profile]").addExamples("player CrypticPlasma",
										"player CrypticPlasma Zucchini")),
				new HelpData("partyfinder", "A party finder helper that shows a player's dungeon stats.",
						"partyfinder [player] [profile]").addAliases("pf").addExamples("partyfinder CrypticPlasma",
								"partyfinder CrypticPlasma Zucchini"),
				// Guild
				new HelpData("guild", "Main guild command")
						.addSecondData("Find what guild a player is in.", "guild <player>")
						.addSubcommands(
								new HelpData("information", "Get information and statistics about a player's guild.",
										"information <u:player>")
												.addSecondData("Get information and statistics about a guild.",
														"information <g:guild_name>")
												.addAliases("info").addExamples("information u:CrypticPlasma",
														"information g:Skyblock_Forceful"),
								new HelpData("members", "Get a list of all members in a player's guild.",
										"members <u:player>")
												.addSecondData("Get a list of all members in a guild.",
														"members <g:guild_name>")
												.addExamples("members u:CrypticPlasma", "members g:Skyblock_Forceful"),
								new HelpData("experience",
										"Get the experience leaderboard for a player's guild. Days can range from 1 to 7, default number of days is 7.",
										"experience <u:player> [days:days]").addAliases("exp").addSecondData(
												...
												.addExamples("experience u:CrypticPlasma",
														"experience g:Skyblock_Forceful days:4"))
						.addAliases("g"),
				new HelpData("guild-leaderboard",
						...
						"guild-leaderboard <type> <u:player> [mode:normal|ironman]").addAliases("g-lb")
								.addExamples("guild-leaderboard weight u:CrypticPlasma"),
				new HelpData("guild-kicker",
						...
						"guild-kicker <u:player> <[type:value ...]> ...").addAliases("g-kicker")
								.addExamples("guild-kicker u:CrypticPlasma [weight:4000 skills:40] [weight:4500]"),
				new HelpData("guild-ranks",
						...
						"guild-ranks <u:player> [mode:normal|ironman]").addAliases("g-ranks").addAliases("g-rank")
				...
				new HelpData("bin", "Get the lowest bin of an item.", "bin <item>").addAliases("lbin")
						.addExamples("bin Necron Chestplate"),
				new HelpData("bazaar", "Get the bazaar prices of an item.", "bazaar <item>").addAliases("bz")
						.addExamples("bazaar Booster Cookie"),
				new HelpData("average", "Get the average auction price of an item.", "average <item>").addAliases("avg")
				...
				new HelpData("query",
						...
						"query <item>").addExamples("query Necron's Chestplate ✪✪✪✪✪"),
				new HelpData("bits", "Get the bits cost of an item from the bits shop.", "bits <item>")
						.addExamples("bits God Potion").addAliases("bit"),
				new HelpData("calculate",
						"Calculate the price of an item on the auction house using the auction's UUID.",
						"calculate <UUID>").addExamples("calculate 8be8bef8c46f4dbda2eccd1ca0c30e27"),
				new HelpData("track", "Main track command").addSubcommands(new HelpData("auctions",
						"Track a player's auctions. You will get a DM whenever any of a player's auctions sell.",
						"track [player]").addExamples("auctions CrypticPlasma"),
						new HelpData("stop", "Stop tracking a player's auctions")),
				// Inventory
				new HelpData("inventory", "Get a player's inventory represented in emojis.",
						"inventory [player] [profile]")
								.addSecondData("Get a player's inventory with lore.",
										"inventory [player] [profile] <slot:number>")
								.addAliases("inv").addExamples("inventory CrypticPlasma",
										"inventory CrypticPlasma Zucchini", "inventory CrypticPlasma slot:1",
				...
				new HelpData("enderchest", "Get a player's ender chest represented in emojis.",
						"enderchest [player] [profile]").addAliases("ec", "echest")
								.addExamples("enderchest CrypticPlasma", "enderchest CrypticPlasma Zucchini"),
				new HelpData("talisman", "Get a player's talisman bag represented in emojis.",
						"talisman [player] [profile]")
								.addSecondData("Get a player's talisman bag with lore.",
										"talisman [player] [profile] <slot:number>")
								.addExamples("talisman CrypticPlasma", "talisman CrypticPlasma Zucchini",
										"talisman CrypticPlasma slot:1", "talisman CrypticPlasma Zucchini slot:1")
								.addAliases("talismans"),
				new HelpData("sacks",
						"Get a player's sacks' content bag represented in a list. Sorted by descending price.",
						"sacks [player] [profile]").addExamples("sacks CrypticPlasma", "sacks CrypticPlasma Zucchini"),
				new HelpData("wardrobe", "Get a player's wardrobe armors represented in emojis.",
						"wardrobe [player] [profile]")
								.addSecondData("Get a player's wardrobe armors represented in a list.",
										"wardrobe list [player] [profile]")
								.addExamples("wardrobe CrypticPlasma", "wardrobe CrypticPlasma Zucchini",
										"wardrobe list CrypticPlasma", "wardrobe list CrypticPlasma Zucchini"),
				new HelpData("pets", "Get a player's pets.", "pets [player] [profile]")
						.addExamples("pets CrypticPlasma", "pets CrypticPlasma Zucchini"),
				// Misc
				new HelpData("roles", "Main roles command.").addAliases("role")
						.addSubcommands(new HelpData("claim",
								"Claim your automatic Skyblock roles. You must be linked to the bot.",
								"claim <profile>").addExamples("claim", "claim Zucchini")),
				new HelpData("bank", "Get a player's bank and purse coins.", "bank [player] [profile]")
						...
						.addExamples("bank CrypticPlasma", "bank CrypticPlasma Zucchini", "bank history CrypticPlasma",
								"bank history CrypticPlasma Zucchini"),
				new HelpData("networth", "Calculate a player's networth.", "networth [player] [profile]")
						.addSecondData("Calculate a player's networth with a detailed JSON of each item cost.",
								"networth [player] [profile] --verbose")
						.addAliases("nw", "n").addExamples("networth CrypticPlasma", "networth CrypticPlasma Zucchini",
								"networth CrypticPlasma --verbose", "networth CrypticPlasma Zucchini --verbose"),
				new HelpData("active-coins",
				...
				new HelpData("weight",
						...
						"weight [player] [profile]")
								...
								.addExamples("weight CrypticPlasma", "weight CrypticPlasma Zucchini",
										"weight calculate 37 600500 23 22"),
				...
				new HelpData("profiles", "Get information about all of a player's profiles.",
						"missing [player] [profile]").addExamples("profiles CrypticPlasma",
								"profiles CrypticPlasma Zucchini"),
				...
				// Party
				new HelpData("party", "Main party command.").addSubcommands(
						...
						new HelpData("join <username>",
								"Join a player's party where username is the party leader's IGN.").addExamples(
										"join CrypticPlasma"),
						...
						new HelpData("kick <username>", "Kick a member from your party")
								.addExamples("kick CrypticPlasma")),
				// Skyblock event
				new HelpData("event", "Main event command.").addSubcommands(
				...
				// Settings
				new HelpData("settings", "Main settings command.").addAliases("config", "configuration")
						.addSecondData("View the current settings for the Discord server.", "settings").addSubcommands(
								new HelpData("delete", "Delete certain settings or all settings from the database.")
										.addSubcommands(new HelpData("all", "Delete the current server settings."),
												new HelpData("hypixel_key",
														"Delete the set Hypixel API of this server."),
												new HelpData("prefix", "Reset the prefix of the bot")),
								new HelpData("set", "Set certain settings.").addSubcommands(new HelpData("hypixel_key",
								...
								new HelpData("verify", "Main command for verification settings.")
										...
										.addSubcommands(new HelpData("enable", "Enable automatic verify."),
												new HelpData("disable", "Disable automatic verify."),
												new HelpData("message",
														"The message that users will see when verifying.",
														"message <message>").addExamples(
																"message Run +link <IGN> replacing IGN with your IGN to verify!"),
												new HelpData("role", "Modify roles given on verification")
														.addSubcommands(new HelpData("add",
												...
												new HelpData("nickname",
														...
														"nickname [prefix] [IGN] [postfix]").addExamples(
																"nickname Verified | [IGN]",
																"nickname [[GUILD_RANK]] [IGN]")),
								new HelpData("roles", "Main command for automatic roles settings.")
										...
										.addSubcommands(
												new HelpData("enable", "Enable automatic roles.").addSecondData(
														"Enable a specific automatic role (disabled by default).",
														"enable <roleName>")
														.addExamples("enable", "enable dungeon_secrets"),
												new HelpData("disable", "Disable automatic roles.")
														.addSecondData("Disable a specific automatic role.",
																"disable <roleName>")
														.addExamples("disable", "disable dungeon_secrets"),
												new HelpData("add",
														"Add a new level to a role with its corresponding Discord role.",
														"add <roleName> <value> <@role>").addExamples(
																"add sven 400000 @sven 8",
																"add alchemy 50 @alchemy 50"),
												new HelpData("remove", "Remove a role level for a role.",
														"remove <roleName> <value>").addExamples("remove sven 400000",
																"remove alchemy 50"),
												new HelpData("set <roleName> <@role>",
														"Set the Discord role for a one level role.",
														"set <roleName> <@role>").addExamples(
																"set ironman @ironman player",
																"set pet_enthusiast @pet lover")),
								new HelpData("guild",
										"Main command for automatic guild (application and guild roles/ranks).")
												.addSecondData("List all setup automatic guilds.", "guild")
												.addSubcommands(
														new HelpData("create",
																"Create a new automatic guild for a guild.",
																"create <name>").addExamples("create myGuild"),
														new HelpData("remove", "Remove an automatic guild.",
																"remove <name>").addExamples("remove myGuild"),
														new HelpData("member_role", "Automatic guild member role.",
																"settings guild <name> member_role", true)
																		.addSubcommands(
																				new HelpData("enable",
																						"Enable automatic guild role."),
																				new HelpData("disable",
																						"Disable automatic guild role."),
																				new HelpData("<@role>",
																						"Set the role to give guild members.")),
														new HelpData("ranks", "Automatic guild ranks.",
																"settings guild <name> ranks", true).addSubcommands(
																		new HelpData("enable",
																				"Enable automatic guild ranks."),
																		new HelpData("disable",
																				"Disable automatic guild ranks."),
																		new HelpData("add", "Add a guild rank.",
																				"add <rank> <@role>"),
																		new HelpData("remove", "Remove a guild rank.",
																				"remove <rank>")),
														new HelpData("counter", "Automatic guild member counter.",
																"settings guild <name> counter", true).addSubcommands(
																		new HelpData("enable",
																				"Enable and create the voice channel for the automatic guild member counter."),
																		new HelpData("disable",
																				"Disable automatic guild member counter.")),
														new HelpData("apply",
																"Automatic application system for this guild.")
																		.addSubcommands(new HelpData("enable",
																				" Enable automatic apply.",
																				"settings guild <name> apply enable",
																				true),
																				new HelpData("disable",
																						" Enable automatic disable.",
																						"settings guild <name> apply disable",
																						true),
																				new HelpData("message",
																						"The message that users will see when verifying.",
																						"settings guild <name> apply message <message>",
																						true),
																				new HelpData("staff_role",
	...
	public static EmbedBuilder getHelp(String pageStr, PaginatorEvent event) {
		...
		if (pageStr != null) {
			...
			if (pageStrSplit.length >= 1) {
				HelpData matchCmd = helpDataList.stream().filter(cmd -> cmd.matchTo(pageStrSplit[0])).findFirst()
						.orElse(null);
				if (matchCmd != null) {
		...
		paginateBuilder.addItems(help.create("help", "Show the help menu with all the commands")
				...
				+ help.create("unlink", "Unlink your account from the bot") + help.create("vote", "Vote for the bot"));
		...
		paginateBuilder.addItems(help.create("dungeons [player] [profile]", "Get the dungeons data of a player")
				+ help.create("essence upgrade <item>",
						"Interactive message to find the essence amount to upgrade an item")
				+ help.create("essence information <item>",
						"Get the amount of essence to upgrade an item for each level")
				+ help.create("essence player [player] [profile]",
						"Get a player's essence amounts and essence shop upgrades")
				+ help.create("partyfinder [player] [profile]",
						"A party finder helper that shows a player's dungeon statistics"));

		paginateBuilder.addItems(help.create("guild <player>", "Find what guild a player is in")
				...
				+ help.create("g-kicker <u:player> <type:value> ...",
				...
				+ help.create("g-ranks <u:player> [mode:normal|ironman]",
						"A customizable helper that will tell you who to promote or demote in your Hypixel guild"));

		paginateBuilder.addItems(help.create("auctions [player] [sort:low|high] [filter:unsold|sold] [--verbose]",
		...
		paginateBuilder.addItems(help.create("inventory [player] [profile]",
				"Get a player's inventory represented in emojis")
				...
				+ help.create("wardrobe list [player] [profile]",
						"Get a player's wardrobe armors represented in a list")
				+ help.create("pets [player] [profile]", "Get a player's pets"));

		paginateBuilder.addItems(help.create("roles claim [profile]",
				"Claim your automatic Skyblock roles based on your statistics")
				...
				+ help.create("active-coins [player] [profile]",
						"Get a player's active coins (bank, purse, and sold auctions)")
				+ help.create("networth [player] [profile]", "Calculate a player's networth")
				+ help.create("networth [player] [profile] --verbose",
				...
				+ help.create("weight calculate <skill avg> <slayer> <cata lvl> <avg dungeon class lvl>",
		...
		paginateBuilder.addItems(help.create("party create", "Interactive message to create a party")
		...
		paginateBuilder
				.addItems(help.createAdmin("event create", "Interactive message to create a Skyblock event", isAdmin)
		...
		if (isAdmin) {
			paginateBuilder.addItems(help.create("settings", "View the current settings for the Discord server")
					...
					+ help.create("settings set pf_category <category>",
			...
			paginateBuilder.addItems(help.create("settings verify", "Get the current verify settings for the bot")
					...
					+ help.create("settings verify role add <@role>",
							"Add a role that user will receive upon being verified")
					+ help.create("settings verify role remove <@role>", "Remove a verify role")
					+ help.create("settings verify channel <#channel>",
							"Channel where the verify message will be sent and messages will be auto deleted")
					+ help.create("settings verify nickname [prefix] [IGN] [postfix]",
							"The nickname template on verifying. Can be set to none.")
					+ help.create("settings verify <enable|disable> sync",
							"Enable or disable automatic verify role and nickname syncing"));

			paginateBuilder.addItems(help.create("settings guild create <name>",
					"Create a new automatic guild where name is the guild's name")
					...
					+ help.create("settings guild <name> member_role <enable|disable>",
							"Enable or disable automatic guild role assigning")
					+ help.create("settings guild <name> member_role <@role>", "Set the role to give guild members")
					+ help.create("settings guild <name> ranks <enable|disable>",
							"Enable or disable automatic guild rank assigning")
					...
					+ help.create("settings guild <name> counter <enable|disable>",
							"Enable or disable guild members counter"));

			paginateBuilder.addItems(help.create("settings guild <name> apply <enable|disable>",
					"Enable or disable automatic apply")
					+ help.create("settings guild <name> apply message <message>",
							"The message that users will see when verifying")
					+ help.create("settings guild <name> apply staff_role add <@role>",
					...
					+ help.create("settings guild <name> apply channel <#channel>",
							"Channel where the message to click for applying will sent")
					+ help.create("settings guild <name> category <category>",
							"Category where new apply channels will be made")
					+ help.create("settings guild <name> apply staff_channel <#channel>",
							"Channel where new applications will be sent to be reviewed by staff")
					+ help.create("settings guild <name> apply waiting_channel <#channel>",
							"Channel where the players who were accepted or waitlisted will be sent. Can be set to none")
					+ help.create("settings guild <name> apply accept_message <message>",
							"Message that will be sent if applicant is accepted")
					+ help.create("settings guild <name> apply waitlist_message <message>",
							"Message that will be sent if applicant is waitlisted. Can be set to none")
					+ help.create("settings guild <name> apply ironman <true|false>",
							"Whether applicants must use an ironman profile. Defaults to false")
					+ help.create("settings guild <name> apply deny_message <message>",
							"Message that will be sent if applicant is denied")
					+ help.create(
					...
					+ help.create("settings guild <name> apply reqs remove <index>",
							"Remove a requirement. Run `settings guild <name>` to see the index for all current requirements"));

			paginateBuilder.addItems(help.create("settings roles", "Get the current roles settings for the bot")
					+ help.create("settings roles <enable|disable>", "Enable or disable automatic roles")
					+ help.create("settings roles <enable|disable> <roleName|all>",
							"Enable or disable a specific automatic role or enable or disable each automatic role")
					+ help.create("settings roles add <roleName> <value> <@role>",
							"Add a new level to a role with its corresponding Discord role")
