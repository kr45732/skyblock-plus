	...
	public static void setHelpList() {
		...
		helpDataList.addAll(
				Arrays.asList(
						...
						new HelpData("hotm", "Get a player's heart of the mountain statistics.",
								"hotm [player] [profile]")
								...
								.addSubcommands(
										...
										new HelpData("members", "Get a list of all members in a player's guild.",
												"members <u:player>")
														...
														.addExamples("members u:CrypticPlasma",
																"members g:Skyblock_Forceful"),
										new HelpData(
												"experience",
						...
						new HelpData(
								...
								"guild-kicker <u:player> <[type:value ...]> ...")
										.addAliases("g-kicker")
										.addExamples(
												"guild-kicker u:CrypticPlasma [weight:4000 skills:40] [weight:4500]"),
						new HelpData(
								"guild-ranks",
						...
						// Auctions
						new HelpData("auctions", "Get a player's unclaimed auctions on all profiles.",
								"auctions [player]")
										.addSecondData("Get information about an auction by it's UUID",
												"auctions uuid <UUID>")
						...
						new HelpData("bank", "Get a player's bank and purse coins.", "bank [player] [profile]")
								.addSecondData("Get a player's bank transaction history.",
										"bank history [player] [profile]")
								.addExamples(
										"bank CrypticPlasma",
						...
						new HelpData(
								...
								"active-coins [player] [profile]")
										.addExamples("active-coins CrypticPlasma",
												"active-coins CrypticPlasma Zucchini")
										.addAliases("ac"),
						new HelpData(
								"weight",
						...
						new HelpData("hypixel", "Get Hypixel information about a player.", "hypixel [player]")
								.addSecondData("Get fastest Hypixel lobby parkour for a player.",
										"hypixel parkour [player]")
						...
						new HelpData("cakes", "Get a player's active and inactive cake buffs.",
								"cakes [player] [profile]")
						...
						new HelpData("party", "Main party command.")
								.addSubcommands(
										...
										new HelpData("join <username>",
												"Join a player's party where username is the party leader's IGN.")
						...
						new HelpData("event", "Main event command.")
								.addSubcommands(
										...
										new HelpData("cancel",
												"Cancel the event. No prizes or winners will be announced.")),
						// Settings
						new HelpData("settings", "Main settings command.")
								...
								.addSubcommands(
										new HelpData("delete",
												"Delete certain settings or all settings from the database.")
														.addSubcommands(
																new HelpData("all",
																		"Delete the current server settings."),
										...
										new HelpData("verify", "Main command for verification settings.")
												.addSecondData("Get the current verification settings for the bot.",
														"verify")
												.addSubcommands(
														...
														new HelpData(
																...
																"nickname [prefix] [IGN] [postfix]")
																		.addExamples("nickname Verified | [IGN]",
												...
												.addSubcommands(
														...
														new HelpData(
																...
																"add <roleName> <value> <@role>")
																		.addExamples("add sven 400000 @sven 8",
																				"add alchemy 50 @alchemy 50"),
														new HelpData("remove", "Remove a role level for a role.",
																"remove <roleName> <value>")
																		.addExamples("remove sven 400000",
																				"remove alchemy 50"),
														new HelpData(
																"set <roleName> <@role>",
																"Set the Discord role for a one level role.",
																"set <roleName> <@role>")
																		.addExamples("set ironman @ironman player",
										...
										new HelpData("guild",
												"Main command for automatic guild (application and guild roles/ranks).")
														...
														.addSubcommands(
																...
																new HelpData("member_role",
																		"Automatic guild member role.",
																...
																new HelpData("ranks", "Automatic guild ranks.",
																		"settings guild <name> ranks", true)
																				.addSubcommands(
																						new HelpData("enable",
																						...
																						new HelpData("remove",
																								"Remove a guild rank.",
																								"remove <rank>")),
																new HelpData("counter",
																		"Automatic guild member counter.",
																		"settings guild <name> counter", true)
																				.addSubcommands(
																						new HelpData(
																								"enable",
	...
	public static EmbedBuilder getHelp(String pageStr, PaginatorEvent event) {
		...
		paginateBuilder.addItems(
				help.create("guild <player>", "Find what guild a player is in") +
						help.create("guild information <u:player>",
								"Get information and statistics about a player's guild")
						+
						...
						help.create("guild experience <u:player>",
								"Get the experience leaderboard for a player's guild")
						+
						help.create("guild experience <g:guild_name>", "Get the experience leaderboard for a guild") +
						help.create("g-lb <type> <u:player> [mode:normal|ironman]",
		...
		paginateBuilder.addItems(
				help.create("inventory [player] [profile]", "Get a player's inventory represented in emojis") +
						...
						+
						help.create("talisman [player] [profile] <slot:number>",
								"Get a player's talisman bag with lore")
						+
						help.create("sacks [player] [profile]",
								"Get a player's sacks' content bag represented in a list")
						+
						help.create("wardrobe [player] [profile]",
								"Get a player's wardrobe armors represented in emojis")
						+
		...
		paginateBuilder.addItems(
				help.create("roles claim [profile]", "Claim your automatic Skyblock roles based on your statistics") +
						...
						help.create("networth [player] [profile] --verbose",
								"Calculate a player's networth with a detailed JSON of each item cost")
						+
						help.create("weight [player] [profile]",
								"Get a player's slayer, skills, dungeons, and total weight")
						+
						help.create(
		...
		if (isAdmin) {
			...
			paginateBuilder.addItems(
					help.create("settings verify", "Get the current verify settings for the bot") +
							...
							help.create("settings verify message <message>",
									"The message that users will see when verifying")
							+
			...
			paginateBuilder.addItems(
					help.create("settings guild create <name>",
							...
							+
							help.create("settings guild <name> member_role <@role>",
									"Set the role to give guild members")
							+
							help.create("settings guild <name> ranks <enable|disable>",
									"Enable or disable automatic guild rank assigning")
							+
							help.create("settings guild <name> ranks add <rank_name> <@role>",
									"Add an automatic guild rank")
							+
							help.create("settings guild <name> ranks remove <rank_name>",
									"Remove an automatic guild rank")
							+
			...
			paginateBuilder.addItems(
					help.create("settings guild <name> apply <enable|disable>", "Enable or disable automatic apply") +
							...
							+
							help.create(
									"settings guild <name> apply staff_role remove <@role>", "Remove a staff ping role")
							+
