...
public class LeaderboardPaginator {
    ...
    public LeaderboardPaginator(String lbType,
        ...
        message = event.getChannel().sendMessageEmbeds(getRender().build()).setActionRow(
                Button
                ...
                Button
                        .primary("leaderboard_paginator_right_button", Emoji.fromMarkdown("<:right_button_arrow:885628386578423908>"))
        ).complete();
    ...
    private EmbedBuilder getRender() {
        ...
        for (int i = pageFirstRank; i < pageFirstRank + 20; i++) {
            ...
            if(curPlayer != null){
                ...
                String out = "`" + i + ")` " + fixUsername(curPlayer.getString("username")) + ": " + (roundAndFormat(lbType.equals("networth") ? (long) curAmount : curAmount));
        ...
        return
                defaultEmbed("Global Leaderboard | " + capitalizeString(gamemode.toString()), "https://hypixel-leaderboard.senither.com/players")
                        .setDescription(isPlayer ? "**Player:** " +
                                ...
                                ":** " +
                                playerAmount : "").addField("", columnOne.toString(), true).addField("", columnTwo.toString(), true)
    ...
    public void action(ButtonInteractionEvent event) {
        ...
        event.editMessageEmbeds(getRender().build()).setActionRow(
                Button
                        .primary("leaderboard_paginator_left_button", Emoji.fromMarkdown("<:left_button_arrow:885628386435821578>"))
                        .withDisabled(pageFirstRank == 1),
                Button
