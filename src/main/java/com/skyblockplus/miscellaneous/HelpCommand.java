...
public class HelpCommand extends Command {
    ...
    new Thread(
      () -> {
        ...
        paginateBuilder.addItems(
          ...
          generateHelp(
            "Go to the help page of a specific command",
            "help [command name]"
          ) +
          generateHelp(
          ...
          generateHelp(
            "Link your discord and Hypixel account",
            "link [player]"
          ) +
        ...
        paginateBuilder.addItems(
          generateHelp(
            "Get the slayer data of a player",
        ...
        paginateBuilder.addItems(
          generateHelp(
            "Get the skills data of a player",
        ...
        paginateBuilder.addItems(
          generateHelp(
            "Get the dungeons data of a player",
            "catacombs [player] <profile>",
            "cata [player] " + "<profile>"
          ) +
          generateHelp(
        ...
        paginateBuilder.addItems(
          ...
          generateHelp(
            "Get information and statistics about a guild",
            "guild info [g:player]"
          ) +
          generateHelp(
            "Get a list of all members in a player's guild",
            "guild members [u:player]"
          ) +
          generateHelp(
            "Get the experience leaderboard for a player's guild",
            "guild experience [u:player]",
            "guild exp [u:player]"
          ) +
          generateHelp(
            "Get the application requirements set for this server",
            "guild-requirements [name]",
            "g-reqs [name]"
          )
        );
        ...
        paginateBuilder.addItems(
          generateHelp(
            "Get player's active (not claimed) auctions on all profiles",
            "auction [player]",
            "ah [player]"
          ) +
          generateHelp("Get the lowest bin of an item", "bin [item]") +
          generateHelp(
            "Get bazaar prices of an item",
            "bazaar [item]",
            "bz [item]"
          ) +
          generateHelp(
            "Get the average auction price of an item",
            "average [item]",
            "avg [item]"
          ) +
          ...
          generateHelp(
            "Get the price of an item from the bits shop",
            "bits [item]"
          )
        );
        ...
        paginateBuilder.addItems(
          ...
          generateHelp(
            "Get a player's equipped armor with lore",
            "inventory armor [player] <profile>",
            "inv armor [player] <profile>"
          ) +
          generateHelp(
            "Get a player's ender chest represented in emojis",
            "enderchest [player] <profile>",
            "echest [player] <profile>"
          ) +
          generateHelp(
            "Get a player's talisman bag represented in emojis",
        ...
        paginateBuilder.addItems(
          generateHelp(
            "Claim automatic Skyblock roles. The player must be linked",
            "roles claim <profile>"
          ) +
          generateHelp(
            "Get a player's bank and purse coins",
            "bank [player] <profile>"
          ) +
          generateHelp(
            "Get a player's bank transaction history",
            "bank history [player] <profile>"
          ) +
          generateHelp(
            "Get a player's networth",
            "networth [player] <profile>",
            "nw [player] <profile>"
          ) +
          generateHelp(
          ...
          generateHelp(
            "Get Hypixel information about a player",
            "hypixel [player]"
          ) +
          generateHelp(
            "Get fastest Hypixel lobby parkour for a player",
            "hypixel parkour [player]"
          ) +
          generateHelp(
            "Get a information about all of a player's profiles",
            "profiles [player]"
          ) +
          generateHelp(
            "Get a player's missing talismans",
        ...
        paginateBuilder.addItems(
          (
            isAdmin
              ? generateHelp(
                "Interactive message to create a Skyblock event",
                "event create"
              )
              : ""
          ) +
          ...
          generateHelp(
            "Get the leaderboard for current event",
            "event leaderboard",
            "event lb"
          ) +
        ...
        if (isAdmin) {
          paginateBuilder.addItems(
            ...
            generateHelp(
              "Get the id's of all categories in guild",
              "categories"
            ) +
            generateHelp(
          ...
          paginateBuilder.addItems(
            generateHelp(
              "Get the current verify settings for the bot",
              "settings verify"
            ) +
            generateHelp(
              "Enable or disable automatic verify",
              "settings verify [enable|disable]"
            ) +
            generateHelp(
              "Message that users will see and react to in order to verify",
            ...
            generateHelp(
              "Remove a verify role",
              "settings verify role remove [@role]"
            ) +
            generateHelp(
              "Channel where the message to react for verifying will sent",
          ...
          paginateBuilder.addItems(
            generateHelp(
              "Get the current apply names for the bot",
              "settings apply"
            ) +
            generateHelp(
              "Create a new automatic apply with name 'name'",
              "settings apply create [name]"
            ) +
            generateHelp(
              "Delete an automatic apply",
              "settings apply remove [name]"
            ) +
            generateHelp(
              "Enable or disable automatic apply",
              "settings apply [name] [enable|disable]"
            ) +
            generateHelp(
          ...
          paginateBuilder.addItems(
            generateHelp(
              "Get the current roles settings for the bot",
              "settings roles"
            ) +
            generateHelp(
              "Enable or disable automatic roles",
              "settings roles [enable|disable]"
            ) +
            generateHelp(
              "Enable a specific automatic role (set to disable by default)",
            ...
            generateHelp(
              "Remove a role level for a role",
              "settings roles remove [roleName] [value]"
            ) +
            generateHelp(
              "Make a specific role stackable",
              "settings roles stackable [roleName] [true|false]"
            ) +
            generateHelp(
              "Set a one level role's role",
              "settings roles set [roleName] [@role]"
            )
          );

          paginateBuilder.addItems(
            generateHelp(
              "Create a new guild roles with name `name`",
            ...
            generateHelp(
              "Set the guild name",
              "settings guild [name] set [guild_name]"
            ) +
            generateHelp(
              "Set the role to give guild member's",
              "settings guild [name] role [@role]"
            ) +
            generateHelp(
            ...
            generateHelp(
              ...
              "settings guild [name] add [rank_name] [@role]"
            ) +
            generateHelp(
              "Remove an automatic guild rank",
              "settings guild [name] remove [rank_name]"
            )
          );
        }
  ...
  private Map<String, Integer> putMultiple(
