...
public class Weight {
  ...
  public double getSlayerWeight() {
    ...
    slayerWeight.addSlayerWeight(
      "rev",
      slayerWeights.get("rev")[0],
      slayerWeights.get("rev")[1]
    );
    slayerWeight.addSlayerWeight(
      "sven",
      slayerWeights.get("sven")[0],
      slayerWeights.get("sven")[1]
    );
    slayerWeight.addSlayerWeight(
      "tara",
      slayerWeights.get("tara")[0],
      slayerWeights.get("tara")[1]
    );
  ...
  public double getSkillsWeight() {
    ...
    skillsWeight.addSkillWeight(
      ...
      skillWeights.get("mining")[1]
    );
    skillsWeight.addSkillWeight(
      "foraging",
      skillWeights.get("foraging")[0],
      skillWeights.get("foraging")[1]
    );
    skillsWeight.addSkillWeight(
      "enchanting",
      skillWeights.get("enchanting")[0],
      skillWeights.get("enchanting")[1]
    );
    skillsWeight.addSkillWeight(
      "farming",
      skillWeights.get("farming")[0],
      skillWeights.get("farming")[1]
    );
    skillsWeight.addSkillWeight(
      "combat",
      skillWeights.get("combat")[0],
      skillWeights.get("combat")[1]
    );
    skillsWeight.addSkillWeight(
      "fishing",
      skillWeights.get("fishing")[0],
      skillWeights.get("fishing")[1]
    );
    skillsWeight.addSkillWeight(
      "alchemy",
      skillWeights.get("alchemy")[0],
      skillWeights.get("alchemy")[1]
    );
    skillsWeight.addSkillWeight(
      "taming",
      skillWeights.get("taming")[0],
      skillWeights.get("taming")[1]
    );
  ...
  public double calculateDungeonsWeight() {
    ...
    dungeonsWeight.addCatacombsWeight(
      catacombs,
      catacombsWeights.get("catacombs")
    );
    return dungeonsWeight.getDungeonsWeight();
  }
}
