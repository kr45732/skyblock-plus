    ...
    public static EmbedBuilder getPlayerWeight(String username, String profileName, PaginatorEvent event) {
        ...
        if (player.isValid()) {
            ...
            for (String slayerName : SLAYER_NAMES) {
                slayerStr.append(SLAYER_EMOJI_MAP.get(slayerName)).append(" ").append(capitalizeString(slayerName))
                        .append(": ")
            ...
            for (String skillName : SKILL_NAMES) {
                skillsStr.append(SKILLS_EMOJI_MAP.get(skillName)).append(" ").append(capitalizeString(skillName))
                        .append(": ")
            ...
            dungeonsStr.append(DUNGEON_EMOJI_MAP.get("catacombs")).append(" ").append(capitalizeString("catacombs"))
                    .append(": ")
                    .append(weight.getDungeonsWeight().getDungeonWeight("catacombs").getFormatted())
                    .append("\n");
            for (String dungeonClassName : DUNGEON_CLASS_NAMES) {
                dungeonsStr.append(DUNGEON_EMOJI_MAP.get(dungeonClassName)).append(" ").append(capitalizeString(dungeonClassName))
                        .append(": ")
            ...
            com.skyblockplus.weight.lily.Weight lilyWeight = new com.skyblockplus.weight.lily.Weight(player);
            EmbedBuilder lilyEb = player.defaultPlayerEmbed(" | Lily Weight");
            StringBuilder lilySlayerStr = new StringBuilder();
            for (String slayerName : SLAYER_NAMES) {
                lilySlayerStr.append(SLAYER_EMOJI_MAP.get(slayerName)).append(" ").append(capitalizeString(slayerName))
                        .append(": ")
            ...
            for (String skillName : SKILL_NAMES) {
                lilySkillsStr.append(SKILLS_EMOJI_MAP.get(skillName)).append(" ").append(capitalizeString(skillName))
                        .append(": ")
