...
public class ServerSettingsService {
  ...
  public ResponseEntity<HttpStatus> addNewServerSettings(
    String serverId,
    ServerSettingsModel newServerSettings
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
      serverId
    );
  ...
  public ResponseEntity<HttpStatus> updateServerSettings(
    String serverId,
    ServerSettingsModel newServerSettings
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
  ...
  public ResponseEntity<?> getVerifySettings(String serverId) {
    ...
    if (currentServerSettings != null) {
      return new ResponseEntity<>(
        currentServerSettings.getAutomatedVerify(),
        HttpStatus.OK
      );
    }
    return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
  ...
  public ResponseEntity<HttpStatus> updateVerifySettings(
    String serverId,
    AutomatedVerify newVerifySettings
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
      serverId
    );
  ...
  public ResponseEntity<?> getRolesSettings(String serverId) {
    ...
    if (currentServerSettings != null) {
      return new ResponseEntity<>(
        currentServerSettings.getAutomatedRoles(),
        HttpStatus.OK
      );
    }
    return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
  ...
  public ResponseEntity<?> getRoleSettings(String serverId, String roleName) {
    ...
    if (currentServerSettings != null) {
      ...
      switch (roleName) {
        case "sven":
          return new ResponseEntity<>(
            currentRoleSettings.getSven(),
            HttpStatus.OK
          );
        case "rev":
          return new ResponseEntity<>(
            currentRoleSettings.getRev(),
            HttpStatus.OK
          );
        case "tara":
          return new ResponseEntity<>(
            currentRoleSettings.getTara(),
            HttpStatus.OK
          );
        case "bank_coins":
          return new ResponseEntity<>(
            currentRoleSettings.getBank_coins(),
            HttpStatus.OK
          );
        case "alchemy":
          return new ResponseEntity<>(
            currentRoleSettings.getAlchemy(),
            HttpStatus.OK
          );
        case "combat":
          return new ResponseEntity<>(
            currentRoleSettings.getCombat(),
            HttpStatus.OK
          );
        case "fishing":
          return new ResponseEntity<>(
            currentRoleSettings.getFishing(),
            HttpStatus.OK
          );
        case "foraging":
          return new ResponseEntity<>(
            currentRoleSettings.getForaging(),
            HttpStatus.OK
          );
        case "carpentry":
          return new ResponseEntity<>(
            currentRoleSettings.getCarpentry(),
            HttpStatus.OK
          );
        case "farming":
          return new ResponseEntity<>(
            currentRoleSettings.getFarming(),
            HttpStatus.OK
          );
        case "mining":
          return new ResponseEntity<>(
            currentRoleSettings.getMining(),
            HttpStatus.OK
          );
        case "taming":
          return new ResponseEntity<>(
            currentRoleSettings.getTaming(),
            HttpStatus.OK
          );
        case "enchanting":
          return new ResponseEntity<>(
            currentRoleSettings.getEnchanting(),
            HttpStatus.OK
          );
        case "catacombs":
          return new ResponseEntity<>(
            currentRoleSettings.getCatacombs(),
            HttpStatus.OK
          );
        case "guild_member":
          return new ResponseEntity<>(
            currentRoleSettings.getGuild_member(),
            HttpStatus.OK
          );
        case "fairy_souls":
          return new ResponseEntity<>(
            currentRoleSettings.getFairy_souls(),
            HttpStatus.OK
          );
        case "slot_collector":
          return new ResponseEntity<>(
            currentRoleSettings.getSlot_collector(),
            HttpStatus.OK
          );
        case "pet_enthusiast":
          return new ResponseEntity<>(
            currentRoleSettings.getPet_enthusiast(),
            HttpStatus.OK
          );
        case "doom_slayer":
          return new ResponseEntity<>(
            currentRoleSettings.getDoom_slayer(),
            HttpStatus.OK
          );
        case "all_slayer_nine":
          return new ResponseEntity<>(
            currentRoleSettings.getAll_slayer_nine(),
            HttpStatus.OK
          );
        case "skill_average":
          return new ResponseEntity<>(
            currentRoleSettings.getSkill_average(),
            HttpStatus.OK
          );
        case "pet_score":
          return new ResponseEntity<>(
            currentRoleSettings.getPet_score(),
            HttpStatus.OK
          );
        case "dungeon_secrets":
          return new ResponseEntity<>(
            currentRoleSettings.getDungeon_secrets(),
            HttpStatus.OK
          );
        case "guild_ranks":
          return new ResponseEntity<>(
            currentRoleSettings.getGuild_ranks(),
            HttpStatus.OK
          );
      }
    }
  ...
  public ResponseEntity<HttpStatus> updateRolesSettings(
    String serverId,
    AutomatedRoles newRoleSettings
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
      serverId
    );
  ...
  public ResponseEntity<HttpStatus> updateRoleSettings(
    String serverId,
    RoleModel newRoleSettings,
    String roleName
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
      serverId
  ...
  public ResponseEntity<HttpStatus> updateRolesEnable(
    String serverId,
    String newEnableSetting
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
      serverId
    );
  ...
  public ResponseEntity<?> getApplyUsersCache(String serverId, String name) {
    AutomatedApplication automatedApplication = getApplySettings(
      serverId,
      name
    );
    ...
    if (automatedApplication != null) {
      return new ResponseEntity<>(
        automatedApplication.getApplyUsersCache(),
        HttpStatus.OK
      );
    }
    return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
  ...
  public ResponseEntity<HttpStatus> updateApplyUsersCache(
    String serverId,
    String name,
    String newApplyCacheJsonString
  ) {
    AutomatedApplication automatedApplication = getApplySettings(
      serverId,
      name
  ...
  public ResponseEntity<?> getSkyblockEventSettings(String serverId) {
    ...
    if (currentServerSettings != null) {
      return new ResponseEntity<>(
        currentServerSettings.getSbEvent(),
        HttpStatus.OK
      );
    }
    return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
  ...
  public ResponseEntity<?> getRunningSkyblockEventSettings(String serverId) {
    ...
    if (currentServerSettings != null) {
      if (getSkyblockEventActive(serverId)) {
        return new ResponseEntity<>(
          currentServerSettings.getSbEvent().getRunningEvent(),
          HttpStatus.OK
        );
      }
    }
  ...
  public boolean getSkyblockEventActive(String serverId) {
    ...
    if (currentServerSettings != null) {
      try {
        if (
          currentServerSettings.getSbEvent().getEventActive().equals("true")
        ) {
          return true;
        }
  ...
  public ResponseEntity<HttpStatus> updateSkyblockRunningEvent(
    String serverId,
    RunningEvent newSettings
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
      serverId
    );
  ...
  public ResponseEntity<HttpStatus> updateSkyblockEventSettings(
    String serverId,
    SbEvent newSettings
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
  ...
  public ResponseEntity<HttpStatus> addEventMemberToRunningEvent(
    String serverId,
    ...
    if (currentServerSettings != null) {
      if (getSkyblockEventActive(serverId)) {
        RunningEvent runningEvent = currentServerSettings
          .getSbEvent()
          .getRunningEvent();
        ...
        return new ResponseEntity<>(
          updateSkyblockRunningEvent(serverId, runningEvent).getStatusCode()
        );
      }
    }
    return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
  ...
  public ResponseEntity<HttpStatus> removeEventMemberToRunningEvent(
    String serverId,
    ...
    if (currentServerSettings != null) {
      if (getSkyblockEventActive(serverId)) {
        RunningEvent runningEvent = currentServerSettings
          ...
          .getRunningEvent();
        List<EventMember> eventMembers = runningEvent.getMembersList();
        eventMembers.removeIf(
          eventMember -> eventMember.getUuid().equals(minecraftUuid)
        );
        runningEvent.setMembersList(eventMembers);
  ...
  public ResponseEntity<HttpStatus> updateApplyReqs(
    String serverId,
    String name,
    ApplyRequirements[] newReqs
  ) {
    AutomatedApplication applySettings = getApplySettings(serverId, name);
  ...
  public List<AutomatedApplication> getAllApplySettings(String serverId) {
    ...
    if (currentServerSettings != null) {
      return new ArrayList<>(
        Arrays.asList(
          currentServerSettings.getAutomatedApplicationOne(),
          currentServerSettings.getAutomatedApplicationTwo()
        )
      );
    }
    return null;
  ...
  public ResponseEntity<HttpStatus> updateApplySettings(
    String serverId,
    AutomatedApplication newSettings
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
      serverId
    );
    ...
    if (currentServerSettings != null) {
      ...
      if (
        ...
        currentServerSettings
          .getAutomatedApplicationOne()
          .getName()
          .equalsIgnoreCase(applySettingsName)
      ) {
  ...
  public ResponseEntity<HttpStatus> updateGuildRoleSettings(
    String serverId,
    GuildRole newSettings
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
      serverId
    );
  ...
  public ResponseEntity<HttpStatus> updateVerifyRolesSettings(
    String serverId,
    String[] newSettings
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
    ...
    if (currentServerSettings != null) {
      ...
      verifySettings.setVerifiedRoles(
        new ArrayList<>(Arrays.asList(newSettings))
      );
  ...
  public ResponseEntity<HttpStatus> removeApplySettings(
    String serverId,
    String name
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
    ...
    if (currentServerSettings != null) {
      ...
      if (applyOne != null && applyOne.getName().equalsIgnoreCase(name)) {
        currentServerSettings.setAutomatedApplicationOne(
          new AutomatedApplication()
        );
      } else if (
        applyTwo != null && applyTwo.getName().equalsIgnoreCase(name)
      ) {
        currentServerSettings.setAutomatedApplicationTwo(
          new AutomatedApplication()
        );
      } else {
        return new ResponseEntity<>(HttpStatus.BAD_REQUEST);
  ...
  public List<GuildRole> getAllGuildRolesSettings(String serverId) {
    ...
    if (currentServerSettings != null) {
      return new ArrayList<>(
        Arrays.asList(
          currentServerSettings.getAutomaticGuildRolesOne(),
  ...
  public ResponseEntity<?> getGuildRoleSettingsExt(
    String serverId,
    String name
  ) {
    ServerSettingsModel currentServerSettings = settingsRepository.findServerByServerId(
