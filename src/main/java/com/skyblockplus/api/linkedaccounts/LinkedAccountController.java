...
public class LinkedAccountController {
  ...
  public ResponseEntity<?> getByMinecraftUuid(
    @RequestParam(value = "minecraftUuid") String minecraftUuid
  ) {
    return settingsService.getByMinecraftUuid(minecraftUuid);
  }

  @GetMapping("/get/by/minecraftUsername")
  public ResponseEntity<?> getByMinecraftUsername(
  ...
  public ResponseEntity<HttpStatus> addNewLinkedAccount(
    @RequestBody LinkedAccountModel linkedAccountModel
  ) {
