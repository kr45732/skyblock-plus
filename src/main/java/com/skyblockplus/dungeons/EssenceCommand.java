        ...
        if (itemJson != null) {
            ...
            for (String level : getJsonKeys(itemJson)) {
                switch (level) {
                    ...
                    case "dungeonize" -> eb.addField("Dungeonize item", higherDepth(itemJson, level).getAsString() + " " + essenceType + " essence", false);
                    case "1" -> eb.addField(level + " star", higherDepth(itemJson, level).getAsString() + " " + essenceType + " essence", false);
                    default -> eb.addField(level + " stars", higherDepth(itemJson, level).getAsString() + " " + essenceType + " essence", false);
                }
            }
