    ...
    public EmbedBuilder getPlayerSlayer(String username, String profile) {
        ...
        eb.setDescription("**Total slayer:** "
                + ((slayerWolf != -1 && slayerZombie != -1 && slayerSpider != -1) ? formatNumber(totalSlayer) + " XP"
                        : "None"));
        eb.addField("Wolf", (slayerWolf != -1 ? formatNumber(slayerWolf) + " XP" : "None"), true);
        eb.addField("Zombie", (slayerZombie != -1 ? formatNumber(slayerZombie) + "XP" : "None"), true);
        eb.addField("Spider", (slayerSpider != -1 ? formatNumber(slayerSpider) + " XP" : "None"), true);
